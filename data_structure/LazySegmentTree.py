...
class SegmentTree:
    def __init__(
        ...
        identity_e_lazy,        # 値データの単位元
        combine_node_f,         # 2つのデータから値を合成させるための関数
        combine_lazy_f,         # 遅延データを伝搬させるのに使う関数
